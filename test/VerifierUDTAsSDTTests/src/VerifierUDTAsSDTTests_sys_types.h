/*----------------------------------------------------------------------------
 * File:  VerifierUDTAsSDTTests_sys_types.h
 *
...
#ifndef VERIFIERUDTASSDTTESTS_SYS_TYPES_H
#define VERIFIERUDTASSDTTESTS_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
...
typedef struct {
  i_t IntegerMember;
} VerifierUDTAsSDTTests_sdt_SDT;

#define SYSTEM_DOMAIN_COUNT 1
/* xtUML domain identification numbers */
#define ExecutableComponent_DOMAIN_ID 0
...
#endif
#endif  /* VERIFIERUDTASSDTTESTS_SYS_TYPES_H */
