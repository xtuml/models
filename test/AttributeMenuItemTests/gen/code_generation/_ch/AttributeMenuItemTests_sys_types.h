/*----------------------------------------------------------------------------
 * File:  AttributeMenuItemTests_sys_types.h
 *
...
#ifndef ATTRIBUTEMENUITEMTESTS_SYS_TYPES_H
#define ATTRIBUTEMENUITEMTESTS_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
...
#endif
#endif  /* ATTRIBUTEMENUITEMTESTS_SYS_TYPES_H */
