...
extern Escher_iHandle_t Escher_CreateInstance( const Escher_DomainNumber_t, const Escher_ClassNumber_t );
extern void Escher_DeleteInstance( Escher_iHandle_t, const Escher_DomainNumber_t, const Escher_ClassNumber_t );
/*
 ...
 */
extern void Escher_ClassFactoryInit( const Escher_DomainNumber_t, const Escher_ClassNumber_t );
