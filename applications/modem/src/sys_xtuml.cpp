 ...
 */
void
sys_sets::Escher_memset( void * const dst, const u1_t val, u2_t len )
{
  u1_t * d = (u1_t *) dst;
  while ( len > 0 ) {
    len--;
 ...
 */
void
sys_sets::Escher_memmove( void * const dst, const void * const src, u2_t len )
{
  u1_t * s = (u1_t *) src;
  u1_t * d = (u1_t *) dst;
  while ( len > 0 ) {
 ...
 */
void
sys_events::Escher_SendSelfEvent( Escher_xtUMLEvent_t * event )
{
  sc_event * sc_e = event->sc_e;
 ...
 * event will be returned.
 */
Escher_xtUMLEvent_t * sys_events::DequeueOoaSelfEvent( void )
{
  Escher_xtUMLEvent_t * event;
  xtUMLEventQueue_t * q = &self_event_queue[ 0 ];
  /* Assign the event from the head of the queue.  */
 ...
 */
void sys_events::ooa_loop( const u1_t d, const u1_t c, void * thismodule )
{
  Escher_xtUMLEvent_t * event;
 ...
 */
void sys_events::Escher_xtUML_run( void )
{
}
