...
#ifndef CAPSSHARE_SYS_TYPES_H
#define CAPSSHARE_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
 ...
 */
typedef enum {
 capsshare_valve_position__UNINITIALIZED__e = -1,
 capsshare_valve_position_closed_e = 0,
 capsshare_valve_position_open_e = 1
} capsshare_valve_position_t;

/*
 * Enumerated Data Type:  gender
 */
typedef enum {
 capsshare_gender__UNINITIALIZED__e = -1,
 capsshare_gender_male_e = 0,
 capsshare_gender_female_e = 1
} capsshare_gender_t;
 ...
 */
typedef enum {
 capsshare_language__UNINITIALIZED__e = -1,
 capsshare_language_English_e = 0,
 capsshare_language_Spanish_e = 1,
 capsshare_language_Japanese_e = 2
} capsshare_language_t;

/*
 * Enumerated Data Type:  color
 */
typedef enum {
 capsshare_color__UNINITIALIZED__e = -1,
 capsshare_color_green_e = 0,
 capsshare_color_yellow_e = 1,
 capsshare_color_red_e = 2
} capsshare_color_t;
