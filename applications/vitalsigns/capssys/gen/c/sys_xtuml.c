...
Escher_Extent_t * const * const domain_class_info[ SYSTEM_DOMAIN_COUNT ] = {
  ...
  0,
  &SpO2_class_info[0],
  &infusion_class_info[0],
  &monitor_class_info[0]
};
...
typedef union {
  ...
  SpO2_DomainEvents_u mc_events_in_domain_SpO2;
  monitor_DomainEvents_u mc_events_in_domain_monitor;
...
static void ooa_loop( void )
{
   ...
   */
  static const EventTaker_t * DomainClassDispatcherTable[ 5 ] =
    {
      0,
      0,
      SpO2_EventDispatcher,
      infusion_EventDispatcher,
      monitor_EventDispatcher
    };
  Escher_xtUMLEvent_t * event;
