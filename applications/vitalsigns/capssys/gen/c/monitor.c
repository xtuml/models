 ...
 */
void
monitor_heart_waveform( const i_t p_amplitude, const i_t p_pulse, const i_t p_t )
{
  /* electrocardiograph::update( pulse:PARAM.pulse ) */
  XTUML_OAL_STMT_TRACE( 1, "electrocardiograph::update( pulse:PARAM.pulse )" );
  monitor_electrocardiograph_op_update( p_pulse );
}
 ...
 */
void
monitor_arm_responsiveness( const i_t p_response_time )
{
}
 ...
 */
void
monitor_capno_respiration( const i_t p_etCO2, const i_t p_expiration, const i_t p_inspiration, const i_t p_rate )
{
}
