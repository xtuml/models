...
#ifndef CAPSSYS_SYS_TYPES_H
#define CAPSSYS_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
...
#define ESCHER_SYS_MAX_ASSOCIATION_EXTENT 10
#define ESCHER_SYS_MAX_TRANSIENT_EXTENT 80
...
#define ESCHER_SYS_MAX_XTUML_TIMERS 11
...
/*
 * Enumerated Data Type:  valve_position
 */
typedef enum {
 capssys_valve_position__UNINITIALIZED__e = -1,
 capssys_valve_position_closed_e = 0,
 capssys_valve_position_open_e = 1
} capssys_valve_position_t;

/*
 * Enumerated Data Type:  gender
 */
typedef enum {
 capssys_gender__UNINITIALIZED__e = -1,
 capssys_gender_male_e = 0,
 capssys_gender_female_e = 1
} capssys_gender_t;

/*
 * Enumerated Data Type:  language
 */
typedef enum {
 capssys_language__UNINITIALIZED__e = -1,
 capssys_language_English_e = 0,
 capssys_language_Spanish_e = 1,
 capssys_language_Japanese_e = 2
} capssys_language_t;
 ...
 */
typedef enum {
 capssys_color__UNINITIALIZED__e = -1,
 capssys_color_green_e = 0,
 capssys_color_yellow_e = 1,
 capssys_color_red_e = 2
} capssys_color_t;



#define SYSTEM_DOMAIN_COUNT 5
/* xtUML domain identification numbers */
#define ARM_DOMAIN_ID 0
#define ARM_DOMAIN_ID_text "ARM"
#include "ARM_classes.h"
#define BUI_DOMAIN_ID 1
#define BUI_DOMAIN_ID_text "BUI"
#include "BUI_classes.h"
#define SpO2_DOMAIN_ID 2
#define SpO2_DOMAIN_ID_text "SpO2"
#include "SpO2_classes.h"
#define infusion_DOMAIN_ID 3
#define infusion_DOMAIN_ID_text "infusion"
#include "infusion_classes.h"
#define monitor_DOMAIN_ID 4
#define monitor_DOMAIN_ID_text "monitor"
