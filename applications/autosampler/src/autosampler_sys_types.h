...
#ifndef AUTOSAMPLER_SYS_TYPES_H
#define AUTOSAMPLER_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
...
#define autosampler_DOMAIN_ID 0
#define autosampler_DOMAIN_ID_text "autosampler"
