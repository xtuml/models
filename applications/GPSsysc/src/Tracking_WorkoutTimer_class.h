...
class Tracking_WorkoutTimer {
  ...
  void Tracking_WorkoutTimer_op_activate( Tracking_WorkoutTimer *, Tracking *);
  void Tracking_WorkoutTimer_op_deactivate( Tracking_WorkoutTimer *, Tracking *);

static void Tracking_WorkoutTimer_R4_Link( Tracking_TrackLog *, Tracking_WorkoutTimer *, Tracking * );
static void Tracking_WorkoutTimer_R4_Unlink( Tracking_TrackLog *, Tracking_WorkoutTimer *, Tracking * );

};

#define Tracking_WorkoutTimer_MAX_EXTENT_SIZE 200
extern sys_sets::Escher_Extent_t pG_Tracking_WorkoutTimer_extent;
