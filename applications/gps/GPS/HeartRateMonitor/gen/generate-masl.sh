...
$MASLMC -domainpath $CWD/masl/HeartRateMonitor:$GEN_HeartRateMonitor_LOG_LOC:$GEN_HeartRateMonitor_Logger_LOC:$GEN_HeartRateMonitor_Format_LOC -mod $CWD/masl/HeartRateMonitor/HeartRateMonitor.mod -output $CWD/gen/code_generation/HeartRateMonitor
