...
domain Tracking is
  ...
  terminator LOC is
    public service getDistance ( toLong: in real,
                                 toLat: in real,
                                 fromLong: in real,
  ...
  object Display is
    ...
    transition is
      Non_Existent ( modeChange => Cannot_Happen,
                     refresh => Cannot_Happen );       
      displayDistance ( modeChange => displaySpeed,
                        refresh => displayDistance );       
      displaySpeed ( modeChange => displayPace,
                     refresh => displaySpeed );       
      displayPace ( modeChange => displayHeartRate,
                    refresh => displayPace );       
      displayHeartRate ( modeChange => displayLapCount,
                         refresh => displayHeartRate );       
      displayLapCount ( modeChange => displayDistance,
  ...
  object Goal is
    ...
    public service initialize ( sequenceNumber: in integer );     
    public instance service calculateStart ();     
    public instance service evaluateAchievement () return GoalDisposition;     
    ...
    transition is
      Non_Existent ( Completed => Cannot_Happen,
      ...
      Paused ( Completed => Completed,
               ...
               Pause => Cannot_Happen,
               evaluationComplete => Cannot_Happen );       
      Evaluating ( Completed => Cannot_Happen,
                   Evaluate => Cannot_Happen,
                   Pause => Cannot_Happen,
  ...
  object WorkoutSession is
    ...
    public instance service getCurrentSpeed () return real;     
    public instance service getCurrentPace () return real;     
    public instance service getCurrentHeartRate () return integer;     
  ...
  object WorkoutTimer is
    ...
    transition is
      Non_Existent ( startStopPressed => Cannot_Happen,
      ...
      stopped ( startStopPressed => processingStart,
                ...
                startTimer => Cannot_Happen,
                lapResetComplete => Cannot_Happen );       
      running ( startStopPressed => paused,
                ...
                startTimer => Cannot_Happen,
                lapResetComplete => Cannot_Happen );       
      paused ( startStopPressed => processingStart,
               ...
               startTimer => Cannot_Happen,
               lapResetComplete => Cannot_Happen );       
      processingStart ( startStopPressed => Cannot_Happen,
                        lapResetPressed => Cannot_Happen,
                        tick => Cannot_Happen,
                        pause => Cannot_Happen,
                        resume => Cannot_Happen,
                        startTimer => running,
                        lapResetComplete => Cannot_Happen );       
      resetLap ( startStopPressed => Cannot_Happen,
                 lapResetPressed => Cannot_Happen,
                 tick => Cannot_Happen,
                 pause => Cannot_Happen,
                 resume => Cannot_Happen,
