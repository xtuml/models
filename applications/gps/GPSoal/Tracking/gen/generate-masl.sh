...
if [[ "" == $GEN_Tracking_UI_LOC ]]; then
  GEN_Tracking_UI_LOC="$CWD/../UI/masl/UI_interface"
fi
...
$MASLMC -domainpath $CWD/masl/Tracking:$GEN_Tracking_UI_LOC:$GEN_Tracking_LOG_LOC:$GEN_Tracking_Logger_LOC:$GEN_Tracking_Format_LOC -mod $CWD/masl/Tracking/Tracking.mod -output $CWD/gen/code_generation/Tracking
$MASLMC -domainpath $GEN_Tracking_UI_LOC -mod $GEN_Tracking_UI_LOC/UI.int -output $CWD/gen/code_generation/UI
