...
#define ESCHER_SYS_MAX_TRANSIENT_EXTENT 1800
...
#define ESCHER_SYS_MAX_NONSELF_EVENTS 17
...
#define SEMAPHORE_FLAVOR_DISPATCH  4
#define SEMAPHORE_FLAVOR_INSTANCE  5
#define SEMAPHORE_FLAVOR_TIMER     6
#define SEMAPHORE_FLAVOR_ILB       7
#define SEMAPHORE_FLAVOR_MAX       8
