...
static const Escher_ClassNumber_t Location_task_numbers[ Location_STATE_MODELS ] = {
  Location_TASK_NUMBERS
};
static const Escher_ClassNumber_t Tracking_task_numbers[ Tracking_STATE_MODELS ] = {
  Tracking_TASK_NUMBERS
};
static const Escher_ClassNumber_t UI_task_numbers[ UI_STATE_MODELS ] = {
  UI_TASK_NUMBERS
};
static const Escher_ClassNumber_t * const class_thread_assignment[ SYSTEM_DOMAIN_COUNT ] = {
  &Location_task_numbers[0],
  &Tracking_task_numbers[0],
  &UI_task_numbers[0]
};
