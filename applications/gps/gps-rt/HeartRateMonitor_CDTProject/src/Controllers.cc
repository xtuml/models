...
static UMLRTCommsPortFarEnd internalfarEndList_Top_HeartRateMonitor[] = 
{
    {
        0,
        NULL
...
UMLRTCommsPort internalports_Top_HeartRateMonitor[] = 
{
    {
        &HeartRateMonitor,
        Capsule_HeartRateMonitor::internalport_timer,
        &Top_slots[InstId_Top_HeartRateMonitor],
        1,
        internalfarEndList_Top_HeartRateMonitor,
        NULL,
        NULL,
        true,
        false,
...
static Capsule_HeartRateMonitor top_HeartRateMonitor( &HeartRateMonitor, &Top_slots[InstId_Top_HeartRateMonitor], borderports_Top_HeartRateMonitor_ptrs, internalports_Top_HeartRateMonitor, true );
UMLRTSlot Top_slots[] = 
{
    {
        "Top",
