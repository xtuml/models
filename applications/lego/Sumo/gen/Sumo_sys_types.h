...
#ifndef SUMO_SYS_TYPES_H
#define SUMO_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
 ...
 */
typedef enum {
 Sumo_Direction__UNINITIALIZED__e = -1,
 Sumo_Direction_backward_e = 0,
 Sumo_Direction_stop_e = 1,
 Sumo_Direction_forward_e = 2
} Sumo_Direction_t;
/*
 * Enumerated Data Type:  Orientation
 */
typedef enum {
 Sumo_Orientation__UNINITIALIZED__e = -1,
 Sumo_Orientation_left_e = 0,
 Sumo_Orientation_straight_e = 1,
 Sumo_Orientation_right_e = 2
} Sumo_Orientation_t;


#define SYSTEM_DOMAIN_COUNT 2
/* xtUML domain identification numbers */
#define EV3_DOMAIN_ID 0
#define EV3_DOMAIN_ID_text "EV3"
#include "EV3_classes.h"
#define sumo_DOMAIN_ID 1
#define sumo_DOMAIN_ID_text "sumo"
