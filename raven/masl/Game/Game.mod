domain Game is
  ...
  public service play ( card: in CardType );   
  
  
  terminator PlayerLogic is
    private service nextPeggingPlay ( cards: in sequence of CardType,
                                      pile_cards: in sequence of CardType );     
  ...
  relationship R12 is Play is_a ( ScoringPlay, NormalPlay );   
  ...
  object Game is
    ...
    transition is
      Non_Existent ( FirstCribPicked => Cannot_Happen,
      ...
      PickingFirstCrib ( FirstCribPicked => Dealing,
                         CardsDealt => Cannot_Happen,
                         CribCardsDiscarded => Cannot_Happen,
                         AllCardsDiscarded => Cannot_Happen,
                         ScoringComplete => Cannot_Happen,
                         ...
                         ContinueScoring => Cannot_Happen,
                         ContinueDiscarding => Cannot_Happen );       
      Dealing ( FirstCribPicked => Cannot_Happen,
                ...
                ContinueScoring => Cannot_Happen,
                ContinueDiscarding => Cannot_Happen );       
      DiscardingToCrib ( FirstCribPicked => Cannot_Happen,
                         CardsDealt => Cannot_Happen,
                         ...
                         ContinueScoring => Cannot_Happen,
                         ContinueDiscarding => Cannot_Happen );       
      DiscardingToPile ( FirstCribPicked => Cannot_Happen,
                         CardsDealt => Cannot_Happen,
                         CribCardsDiscarded => Cannot_Happen,
                         ...
                         ContinueScoring => Cannot_Happen,
                         ContinueDiscarding => Cannot_Happen );       
      Scoring ( FirstCribPicked => Cannot_Happen,
                CardsDealt => Cannot_Happen,
                CribCardsDiscarded => Cannot_Happen,
                AllCardsDiscarded => Cannot_Happen,
                ...
                ContinueScoring => Cannot_Happen,
                ContinueDiscarding => Cannot_Happen );       
      Pegging ( FirstCribPicked => Cannot_Happen,
                CardsDealt => Cannot_Happen,
                CribCardsDiscarded => Cannot_Happen,
                AllCardsDiscarded => Cannot_Happen,
                ScoringComplete => Cannot_Happen,
      ...
      EndOfGame ( FirstCribPicked => Cannot_Happen,
                  CardsDealt => Cannot_Happen,
                  CribCardsDiscarded => Cannot_Happen,
                  AllCardsDiscarded => Cannot_Happen,
                  ScoringComplete => Cannot_Happen,
