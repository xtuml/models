/*----------------------------------------------------------------------------
 * File:  string_return_test_sys_types.h
 *
...
#ifndef STRING_RETURN_TEST_SYS_TYPES_H
#define STRING_RETURN_TEST_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
...
#define NUM_OF_XTUML_CLASS_THREADS 3
...
#define stringtest_DOMAIN_ID 0
#define stringtest_DOMAIN_ID_text "stringtest"
...
#define STATE_TXN_START_TRACE( obj_kl, state_num, state_name ) do { static unsigned short gc; if ( ! gc++ ) {  XTUML_SOURCE_PROLOGUE;   printf( "Transition started:  %s State [%u] %s\n", obj_kl, state_num, state_name ); } } while (0)
#endif
...
#endif
#endif  /* STRING_RETURN_TEST_SYS_TYPES_H */
