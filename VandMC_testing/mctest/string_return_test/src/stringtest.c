...
stringtest_init()
{
  ...
  Escher_strcpy( h->upper, "upper information upper information upper information upper information upper information upper information upper information upper information upper information upper information upper information upper information upper information" );
  ...
  Escher_strcpy( d->lower, "lower storage area lower storage area lower storage area lower storage area lower storage area lower storage area lower storage area lower storage area lower storage area lower storage area lower storage area lower storage area lower storage area" );
