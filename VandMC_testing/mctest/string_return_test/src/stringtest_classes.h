...
#define stringtest_STATE_MODELS 6
...
#define stringtest_spin_CLASS_NUMBER 4
#define stringtest_spun_CLASS_NUMBER 5
#define stringtest_buffer_CLASS_NUMBER 6
#define stringtest_MAX_CLASS_NUMBERS 7

/* Provide a map of classes to task numbers.  */
#define stringtest_TASK_NUMBERS  1, 1, 2, 2, 3, 4
...
#define stringtest_class_dispatchers\
  ...
  stringtest_spin_Dispatch,\
  stringtest_spun_Dispatch
...
typedef struct stringtest_spin stringtest_spin;
typedef struct stringtest_spun stringtest_spun;
...
#include "stringtest_spin_class.h"
#include "stringtest_spun_class.h"
/*
...
typedef union {
  ...
  stringtest_spin_Events_u stringtest_spin_Events_u_namespace;
  stringtest_spun_Events_u stringtest_spun_Events_u_namespace;
