...
#ifndef POLYCALC_SYS_TYPES_H
#define POLYCALC_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
...
#define polycalc_DOMAIN_ID 0
#define polycalc_DOMAIN_ID_text "polycalc"
