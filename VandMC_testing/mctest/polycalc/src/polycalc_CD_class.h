 ...
 */
typedef union {
  polycalc_CDevent_LOCATION_PE2 cd2_1;  
  polycalc_CDevent_PORTAL_PE1 cd1_2;  
 ...
 */
#define POLYCALC_CDEVENT_PORTAL_PE1NUM 0  /* PORTAL1*:'remove' */
#define POLYCALC_CDEVENT_LOCATION_PE2NUM 1  /* LOCATION2*:'mount' */
