 ...
 */
void
perf_funcs_TESTLOOP_runtest( i_t p_duration, i_t p_testnum)
{
 ...
 */
i_t
perf_funcs_TESTLOOP_bridge_integer_integer( i_t p_i)
{
 ...
 */
void
perf_funcs_TESTLOOP_bridge_void_integer( i_t p_i)
{
 ...
 */
bool
perf_funcs_TESTLOOP_perftest( i_t p_count, i_t p_duration, i_t p_phase, i_t p_testnum)
{
  /* RETURN ::perftest(count:PARAM.count, duration:PARAM.duration, phase:PARAM.phase, testnum:PARAM.testnum) */
  return perf_funcs_perftest( p_count, p_duration, p_phase, p_testnum );
}
