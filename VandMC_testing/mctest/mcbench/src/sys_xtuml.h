...
#define Escher_SetRemoveInstance( pextent, instance, slot, container, pool ) \
  slot = (Escher_SetElement_s *)( &container[0] + (instance - &pool[0]) ); \
  Escher_SetRemoveDlistNode( pextent, slot )
 ...
 */
void Escher_SetRemoveDlistNode( Escher_ObjectSet_s *,
                      Escher_SetElement_s * const );
