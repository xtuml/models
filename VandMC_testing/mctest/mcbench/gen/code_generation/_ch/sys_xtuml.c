 ...
 */
void
Escher_SetRemoveDlistNode(
  Escher_ObjectSet_s * set,
  Escher_SetElement_s * const slot
)
{
...
Escher_Extent_t * const * const domain_class_info[ SYSTEM_DOMAIN_COUNT ] = {
  &perf_funcs_class_info[0],
  &perf_testloop_class_info[0]
};
...
typedef union {
  ...
  perf_funcs_DomainEvents_u mc_events_in_domain_perf_funcs;
  perf_testloop_DomainEvents_u mc_events_in_domain_perf_testloop;
