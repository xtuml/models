...
#ifndef CALCULATOR_SYS_TYPES_H
#define CALCULATOR_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
...
#define calc_DOMAIN_ID_text "calc"
#include "calc_classes.h"
#define keypad_DOMAIN_ID 1
#define keypad_DOMAIN_ID_text "keypad"
