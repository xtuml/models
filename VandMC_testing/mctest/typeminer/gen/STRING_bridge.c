 ...
 * Bridge:  quote
 *
 * Not here. Implemented as a macro.
 */
 ...
 */
c_t *
STRING_idtoa( c_t A0xtumlsret[ESCHER_SYS_MAX_STRING_LEN], c_t p_a[ESCHER_SYS_MAX_STRING_LEN], Escher_UniqueID_t p_id )
{
  c_t * result = 0;
  /* Insert your implementation code here... */
  return result;
