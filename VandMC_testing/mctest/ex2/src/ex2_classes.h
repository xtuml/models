...
extern void ex2_execute_initialization( void );

#define ex2_STATE_MODELS 2


/* Define constants to map to class numbers.  */
#define ex2_TCE_CLASS_NUMBER 0
#define ex2_DR_CLASS_NUMBER 1
 ...
 */
extern void ex2_setup( void );
extern void ex2_test( void );
extern void ex2_xit( void );
...
/*
 * roll-up of all events (with their parameters) for domain ex2
 */
typedef union {
