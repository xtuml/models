...
{
  c_t vtrv31ex2_TRAN_op_ret_string15[ESCHER_SYS_MAX_STRING_LEN];c_t str[ESCHER_SYS_MAX_STRING_LEN];c_t str1[ESCHER_SYS_MAX_STRING_LEN];ex2_DR * dr=0;
  /* IF ( ( ( 1 + 2 ) * ( 3 + 4 ) ) == 21 ) */
  if ( ( ( 1 + 2 ) * ( 3 + 4 ) ) == 21 ) {
...
{
  c_t s3[ESCHER_SYS_MAX_STRING_LEN];c_t s2[ESCHER_SYS_MAX_STRING_LEN];c_t s1[ESCHER_SYS_MAX_STRING_LEN];r_t z;r_t y;r_t x;i_t c;i_t b;i_t a;ex2_DR * dr=0;
  /* ASSIGN a = 1 */
  a = 1;
  /* ASSIGN b = 4 */
  b = 4;
...
{
  ex2_A * b;ex2_A * a;ex2_DR * dr=0;
  /* CREATE OBJECT INSTANCE a OF A */
  a = (ex2_A *) Escher_CreateInstance( ex2_DOMAIN_ID, ex2_A_CLASS_NUMBER );
  a->a_id = Escher_ID_factory();
  /* CREATE OBJECT INSTANCE b OF A */
  b = (ex2_A *) Escher_CreateInstance( ex2_DOMAIN_ID, ex2_A_CLASS_NUMBER );
  b->a_id = Escher_ID_factory();
  /* ASSIGN a.a = 5 */
  ((ex2_A *)xtUML_detect_empty_handle( a, "A", "a.a" ))->a = 5;
  /* ASSIGN b.a = 2 */
  ((ex2_A *)xtUML_detect_empty_handle( b, "A", "b.a" ))->a = 2;
  /* IF ( ( ( ( a.a - b.a ) * ( a.a - 3 ) ) + 1 ) == 7 ) */
  if ( ( ( ( ((ex2_A *)xtUML_detect_empty_handle( a, "A", "a.a" ))->a - ((ex2_A *)xtUML_detect_empty_handle( b, "A", "b.a" ))->a ) * ( ((ex2_A *)xtUML_detect_empty_handle( a, "A", "a.a" ))->a - 3 ) ) + 1 ) == 7 ) {
  ...
  /* ASSIGN self.a = 5 */
  ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.a" ))->a = 5;
  /* ASSIGN self.b = 4 */
  ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b" ))->b = 4;
  /* IF ( ( ( self.a + self.b ) - 2 ) == 7 ) */
  if ( ( ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.a" ))->a + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b" ))->b ) - 2 ) == 7 ) {
...
{
  ex2_A * a=0;ex2_DR * dr=0;Escher_ObjectSet_s as_space={0}; Escher_ObjectSet_s * as = &as_space;
...
ex2_TCE_act6( ex2_TCE * self, const Escher_xtUMLEvent_t * const event )
{
  ...
  /* ASSIGN s = TRAN::ret_string(TRAN::ret_string(s:abc)) */
...
{
  i_t day;i_t month;i_t hour;Escher_Date_t date;ex2_DR * dr=0;
...
{
  i_t d;r_t pi;i_t c;i_t b;i_t a;
...
ex2_TCE_act14( ex2_TCE * self, const Escher_xtUMLEvent_t * const event )
{
  ...
  /* IF ( TRUE ) */
  if ( TRUE ) {
    i_t ans1;bool ans;i_t b;i_t a;ex2_NOI * no_instances=0;ex2_TCE * tce=0;
    /* ASSIGN a = 1 */
    a = 1;
    /* ASSIGN b = 2 */
    b = 2;
    ...
    ans = !( ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 ) );
    /* IF ( ans == TRUE ) */
    if ( ans == TRUE ) {
    ...
    ans = !( ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 ) );
    /* IF ( ans == TRUE ) */
    if ( ans == TRUE ) {
    ...
    ans1 = +( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i2" ))->i2 );
    /* IF ( ans1 == 3 ) */
    if ( ans1 == 3 ) {
    ...
    ans1 = +( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i2" ))->i2 );
    /* IF ( ans1 == 3 ) */
    if ( ans1 == 3 ) {
    ...
    /* ASSIGN ans1 = + ( TRAN::ret_int(5) + TRAN::ret_int(- 2) ) */
    ...
    /* ASSIGN ans1 = + ( BR::ret_int(- 3) + BR::ret_int(6) ) */
  ...
  /* IF ( TRUE ) */
  if ( TRUE ) {
    r_t ans2;r_t b;r_t a;ex2_NOI * no_instances=0;ex2_TCE * tce=0;
    /* ASSIGN a = 1.0 */
    a = 1.0;
    /* ASSIGN b = 2.0 */
    b = 2.0;
    ...
    ans2 = +( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 );
    /* IF ( ( ans2 > 2.9 ) and ( ans2 < 3.1 ) ) */
    if ( ( ans2 > 2.9 ) && ( ans2 < 3.1 ) ) {
    ...
    ans2 = +( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 );
    /* IF ( ( ans2 > 2.9 ) and ( ans2 < 3.1 ) ) */
    if ( ( ans2 > 2.9 ) && ( ans2 < 3.1 ) ) {
    ...
    /* ASSIGN ans2 = + ( TRAN::ret_real(5.0) + TRAN::ret_real(- 2.0) ) */
    ...
    /* ASSIGN ans2 = + ( BR::ret_real(- 3.0) + BR::ret_real(6.0) ) */
  ...
  /* IF ( TRUE ) */
  if ( TRUE ) {
    bool ans;bool a1;ex2_NOI * no_instances=0;ex2_TCE * tce=0;
    /* ASSIGN a1 = FALSE */
    a1 = FALSE;
    /* ASSIGN ans = not a1 */
    ans = !a1;
    ...
    ans = !((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b2" ))->b2;
    /* IF ( ans == TRUE ) */
    if ( ans == TRUE ) {
    ...
    ans = !((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b2" ))->b2;
    /* IF ( ans == TRUE ) */
    if ( ans == TRUE ) {
  ...
  /* IF ( TRUE ) */
  if ( TRUE ) {
    i_t ans1;i_t b;ex2_NOI * no_instances=0;ex2_TCE * tce=0;
    /* ASSIGN b = 2 */
    b = 2;
    /* ASSIGN ans1 = + b */
    ans1 = +b;
    ...
    /* ASSIGN ans1 = + self.i2 */
    ans1 = +((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i2" ))->i2;
    /* IF ( ans1 == 2 ) */
    if ( ans1 == 2 ) {
    ...
    tce = (ex2_TCE *) Escher_SetGetAny( &pG_ex2_TCE_extent.active );
    /* ASSIGN ans1 = + tce.i2 */
    ans1 = +((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i2" ))->i2;
    /* IF ( ans1 == 2 ) */
    if ( ans1 == 2 ) {
  ...
  /* IF ( TRUE ) */
  if ( TRUE ) {
    r_t ans2;r_t b;ex2_NOI * no_instances=0;ex2_TCE * tce=0;
    /* ASSIGN b = 2.0 */
    b = 2.0;
    /* ASSIGN ans2 = + b */
    ans2 = +b;
    ...
    /* ASSIGN ans2 = + self.r2 */
    ans2 = +((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2;
    /* IF ( ( ans2 > 1.9 ) and ( ans2 < 2.1 ) ) */
    if ( ( ans2 > 1.9 ) && ( ans2 < 2.1 ) ) {
    ...
    tce = (ex2_TCE *) Escher_SetGetAny( &pG_ex2_TCE_extent.active );
    /* ASSIGN ans2 = + tce.r2 */
    ans2 = +((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2;
    /* IF ( ( ans2 > 1.9 ) and ( ans2 < 2.1 ) ) */
    if ( ( ans2 > 1.9 ) && ( ans2 < 2.1 ) ) {
...
ex2_TCE_act15( ex2_TCE * self, const Escher_xtUMLEvent_t * const event )
{
  ...
  /* IF ( TRUE ) */
  if ( TRUE ) {
    i_t b;i_t a;ex2_NOI * no_instances=0;ex2_TCE * tce=0;
    /* ASSIGN a = 1 */
    a = 1;
    /* ASSIGN b = 2 */
    b = 2;
    ...
    if ( !( ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 ) ) ) {
    ...
    if ( !( ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 ) ) ) {
    ...
    if ( +( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i2" ))->i2 ) == 3 ) {
    ...
    tce = (ex2_TCE *) Escher_SetGetAny( &pG_ex2_TCE_extent.active );
    /* IF ( + ( tce.i1 + tce.i2 ) == 3 ) */
    if ( +( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i2" ))->i2 ) == 3 ) {
    ...
    /* IF ( + ( BR::ret_int(- 3) + BR::ret_int(6) ) == 3 ) */
  ...
  /* IF ( TRUE ) */
  if ( TRUE ) {
    r_t b;r_t a;ex2_NOI * no_instances=0;ex2_TCE * tce=0;
    /* ASSIGN a = 1.0 */
    a = 1.0;
    /* ASSIGN b = 2.0 */
    b = 2.0;
    ...
    if ( ( +( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 ) > 2.9 ) && ( +( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 ) < 3.1 ) ) {
    ...
    if ( ( +( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 ) > 2.9 ) && ( +( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 ) < 3.1 ) ) {
    ...
    /* IF ( ( + ( TRAN::ret_real(5.0) + TRAN::ret_real(- 2.0) ) > 2.9 ) and ( + ( TRAN::ret_real(5.0) + TRAN::ret_real(- 2.0) ) < 3.1 ) ) */
    ...
    /* IF ( ( + ( BR::ret_real(- 3.0) + BR::ret_real(6.0) ) > 2.9 ) and ( + ( BR::ret_real(- 3.0) + BR::ret_real(6.0) ) < 3.1 ) ) */
    ...
    if ( ( -( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 ) > -3.1 ) && ( -( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 ) < -2.9 ) ) {
      /* LOG::LogSuccess( message:TCE - If Expressions - assignment of + (expression) - self - real ) */
      LOG_LogSuccess( "TCE - If Expressions - assignment of + (expression) - self - real" );
    }
    else {
    ...
    if ( ( -( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 ) > -3.1 ) && ( -( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 ) < -2.9 ) ) {
      /* LOG::LogSuccess( message:TCE - If Expressions - assignment of - (expression) - inst_ref - real ) */
      LOG_LogSuccess( "TCE - If Expressions - assignment of - (expression) - inst_ref - real" );
    }
    else {
    ...
    /* IF ( ( - ( TRAN::ret_real(5.0) + TRAN::ret_real(- 2.0) ) > - 3.1 ) and ( - ( TRAN::ret_real(5.0) + TRAN::ret_real(- 2.0) ) < - 2.9 ) ) */
    ...
    /* IF ( ( - ( BR::ret_real(- 3.0) + BR::ret_real(6.0) ) > - 3.1 ) and ( - ( BR::ret_real(- 3.0) + BR::ret_real(6.0) ) < - 2.9 ) ) */
  ...
  /* IF ( TRUE ) */
  if ( TRUE ) {
    bool a1;ex2_NOI * no_instances=0;ex2_TCE * tce=0;
    /* ASSIGN a1 = FALSE */
    a1 = FALSE;
    /* IF ( not a1 == TRUE ) */
    if ( !a1 == TRUE ) {
    ...
    /* IF ( not self.b2 == TRUE ) */
    if ( !((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b2" ))->b2 == TRUE ) {
    ...
    tce = (ex2_TCE *) Escher_SetGetAny( &pG_ex2_TCE_extent.active );
    /* IF ( not tce.b2 == TRUE ) */
    if ( !((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b2" ))->b2 == TRUE ) {
  ...
  /* IF ( TRUE ) */
  if ( TRUE ) {
    i_t b;ex2_NOI * no_instances=0;ex2_TCE * tce=0;
    /* ASSIGN b = 2 */
    b = 2;
    /* IF ( + b == 2 ) */
    if ( +b == 2 ) {
    ...
    /* IF ( + self.i2 == 2 ) */
    if ( +((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i2" ))->i2 == 2 ) {
    ...
    tce = (ex2_TCE *) Escher_SetGetAny( &pG_ex2_TCE_extent.active );
    /* IF ( + tce.i2 == 2 ) */
    if ( +((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i2" ))->i2 == 2 ) {
  ...
  /* IF ( TRUE ) */
  if ( TRUE ) {
    r_t b;ex2_NOI * no_instances=0;ex2_TCE * tce=0;
    /* ASSIGN b = 2.0 */
    b = 2.0;
    /* IF ( ( + b > 1.9 ) and ( + b < 2.1 ) ) */
    if ( ( +b > 1.9 ) && ( +b < 2.1 ) ) {
    ...
    if ( ( +((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 > 1.9 ) && ( +((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 < 2.1 ) ) {
    ...
    if ( ( +((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 > 1.9 ) && ( +((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 < 2.1 ) ) {
    ...
    if ( ( -((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 > -2.1 ) && ( -((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 < -1.9 ) ) {
      /* LOG::LogSuccess( message:TCE - If Expressions - assignment of + (expression) - self - real - single ) */
      LOG_LogSuccess( "TCE - If Expressions - assignment of + (expression) - self - real - single" );
    }
    else {
    ...
    if ( ( -((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 > -2.1 ) && ( -((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 < -1.9 ) ) {
      /* LOG::LogSuccess( message:TCE - If Expressions - assignment of - (expression) - inst_ref - real - single ) */
      LOG_LogSuccess( "TCE - If Expressions - assignment of - (expression) - inst_ref - real - single" );
    }
    else {
  ...
  if ( TRUE ) {
    ...
    else if ( !( ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 ) ) ) {
    ...
    else if ( !( ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 ) ) ) {
  ...
  if ( TRUE ) {
    ...
    else if ( +( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i2" ))->i2 ) == 3 ) {
    ...
    else if ( +( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i2" ))->i2 ) == 3 ) {
  ...
  if ( TRUE ) {
    ...
    else if ( ( +( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 ) > 2.9 ) && ( +( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 ) < 3.1 ) ) {
    ...
    else if ( ( +( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 ) > 2.9 ) && ( +( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 ) < 3.1 ) ) {
    ...
    else if ( ( -( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 ) > -3.1 ) && ( -( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 ) < -2.9 ) ) {
      /* LOG::LogSuccess( message:TCE - Else Expressions - assignment of + (expression) - self - real ) */
      LOG_LogSuccess( "TCE - Else Expressions - assignment of + (expression) - self - real" );
    }
    else {
    ...
    else if ( ( -( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 ) > -3.1 ) && ( -( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r1" ))->r1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 ) < -2.9 ) ) {
      /* LOG::LogSuccess( message:TCE - Else Expressions - assignment of - (expression) - inst_ref - real ) */
      LOG_LogSuccess( "TCE - Else Expressions - assignment of - (expression) - inst_ref - real" );
    }
    else {
  ...
  if ( TRUE ) {
    ...
    else if ( !((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b2" ))->b2 == TRUE ) {
    ...
    else if ( !((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b2" ))->b2 == TRUE ) {
  ...
  if ( TRUE ) {
    ...
    else if ( +((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i2" ))->i2 == 2 ) {
    ...
    else if ( +((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i2" ))->i2 == 2 ) {
  ...
  if ( TRUE ) {
    ...
    else if ( ( +((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 > 1.9 ) && ( +((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 < 2.1 ) ) {
    ...
    else if ( ( +((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 > 1.9 ) && ( +((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 < 2.1 ) ) {
    ...
    else if ( ( -((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 > -2.1 ) && ( -((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.r2" ))->r2 < -1.9 ) ) {
      /* LOG::LogSuccess( message:TCE - Else Expressions - assignment of + (expression) - self - real - single ) */
      LOG_LogSuccess( "TCE - Else Expressions - assignment of + (expression) - self - real - single" );
    }
    else {
    ...
    else if ( ( -((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 > -2.1 ) && ( -((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.r2" ))->r2 < -1.9 ) ) {
      /* LOG::LogSuccess( message:TCE - Else Expressions - assignment of - (expression) - inst_ref - real - single ) */
      LOG_LogSuccess( "TCE - Else Expressions - assignment of - (expression) - inst_ref - real - single" );
    }
    else {
...
{
  ex2_TCEevent4 * rcvd_evt = (ex2_TCEevent4 *) event;
  i_t ack_count;i_t ans1;bool ans;i_t b;i_t a;ex2_TCEevent6 * e2;ex2_TCEevent5 * e1;ex2_NOI * no_instances=0;ex2_TCE * tce=0;ex2_DR * dr=0;
  /* SELECT any dr FROM INSTANCES OF DR */
  dr = (ex2_DR *) Escher_SetGetAny( &pG_ex2_DR_extent.active );
  ...
  ans = ex2_BR_ret_bool( !( ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 ) ) );
  /* IF ( ans ) */
  if ( ans ) {
  ...
  ans = ex2_BR_ret_bool( !( ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 ) ) );
  /* IF ( ans ) */
  if ( ans ) {
  ...
  ans1 = ex2_BR_ret_int( +( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i2" ))->i2 ) );
  /* IF ( ans1 == 3 ) */
  if ( ans1 == 3 ) {
  ...
  ans1 = ex2_BR_ret_int( +( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i2" ))->i2 ) );
  /* IF ( ans1 == 3 ) */
  if ( ans1 == 3 ) {
  ...
  /* ASSIGN ans1 = BR::ret_int(i:+ ( BR::ret_int(- 3) + BR::ret_int(6) )) */
  ...
  ans = ex2_TRAN_op_ret_bool(!( ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 ) ));
  /* IF ( ans ) */
  if ( ans ) {
  ...
  ans = ex2_TRAN_op_ret_bool(!( ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 ) ));
  /* IF ( ans ) */
  if ( ans ) {
  ...
  ans1 = ex2_TRAN_op_ret_int(+( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i2" ))->i2 ));
  /* IF ( ans1 == 3 ) */
  if ( ans1 == 3 ) {
  ...
  ans1 = ex2_TRAN_op_ret_int(+( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i2" ))->i2 ));
  /* IF ( ans1 == 3 ) */
  if ( ans1 == 3 ) {
  ...
  /* ASSIGN ans1 = TRAN::ret_int(i:+ ( TRAN::ret_int(- 3) + TRAN::ret_int(6) )) */
  ...
  e1 = (ex2_TCEevent5 *) Escher_NewxtUMLEvent( (void *) self, &ex2_TCEevent5c );
      e1->p_b1 = !( ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 ) );  /* GENERATE e1 */
  Escher_SendEvent( (Escher_xtUMLEvent_t *) e1 );
  /* ASSIGN ack_count = ( ack_count + 1 ) */
  ack_count = ( ack_count + 1 );
  /* SELECT any tce FROM INSTANCES OF TCE */
  ...
  e1 = (ex2_TCEevent5 *) Escher_NewxtUMLEvent( (void *) self, &ex2_TCEevent5c );
      e1->p_b1 = !( ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 ) );  /* GENERATE e1 */
  Escher_SendEvent( (Escher_xtUMLEvent_t *) e1 );
  /* ASSIGN ack_count = ( ack_count + 1 ) */
  ack_count = ( ack_count + 1 );
  /* SELECT any tce FROM INSTANCES OF TCE */
  ...
  e2 = (ex2_TCEevent6 *) Escher_NewxtUMLEvent( (void *) self, &ex2_TCEevent6c );
      e2->p_i1 = +( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i2" ))->i2 );  /* GENERATE e2 */
  Escher_SendEvent( (Escher_xtUMLEvent_t *) e2 );
  /* ASSIGN ack_count = ( ack_count + 1 ) */
  ack_count = ( ack_count + 1 );
  /* SELECT any tce FROM INSTANCES OF TCE */
  ...
  e2 = (ex2_TCEevent6 *) Escher_NewxtUMLEvent( (void *) self, &ex2_TCEevent6c );
      e2->p_i1 = +( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i2" ))->i2 );  /* GENERATE e2 */
  Escher_SendEvent( (Escher_xtUMLEvent_t *) e2 );
  /* ASSIGN ack_count = ( ack_count + 1 ) */
  ack_count = ( ack_count + 1 );
  /* SELECT any tce FROM INSTANCES OF TCE */
  ...
  /* ASSIGN ack_count = ( ack_count + 1 ) */
  ack_count = ( ack_count + 1 );
  /* CREATE EVENT INSTANCE e2( i1:+ ( TRAN::ret_int(- 3) + TRAN::ret_int(6) ) ) TO self */
  e2 = (ex2_TCEevent6 *) Escher_NewxtUMLEvent( (void *) self, &ex2_TCEevent6c );
  ...
  ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.ack_count" ))->ack_count = ack_count;
}
...
ex2_TCE_act17( ex2_TCE * self, const Escher_xtUMLEvent_t * const event )
{
  ...
  ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.ack_count" ))->ack_count = ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.ack_count" ))->ack_count - 1 );
  /* IF ( self.ack_count == 0 ) */
  if ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.ack_count" ))->ack_count == 0 ) {
    /* GENERATE TCE4:next test with supp data(b2:FALSE, i1:1, i2:2, r1:1.0, r2:2.0, b1:TRUE) TO self */
    { ex2_TCEevent4 * e = (ex2_TCEevent4 *) Escher_NewxtUMLEvent( self, &ex2_TCEevent4c );
      e->p_b2 = FALSE;      e->p_i1 = 1;      e->p_i2 = 2;      e->p_r1 = 1.0;      e->p_r2 = 2.0;      e->p_b1 = TRUE;
      Escher_SendSelfEvent( (Escher_xtUMLEvent_t *) e );
...
{
  ex2_TCEevent4 * rcvd_evt = (ex2_TCEevent4 *) event;
  bool bv;i_t b;i_t a;i_t ack_count;ex2_TCE * t3;ex2_TCE * t2;Escher_ObjectSet_s tces_space={0}; Escher_ObjectSet_s * tces = &tces_space;ex2_NOI * no_instances=0;ex2_TCE * tce=0;
  /* ASSIGN ack_count = 0 */
  ack_count = 0;
  /* ASSIGN a = 1 */
  a = 1;
  ...
  { ex2_TCEevent5 * e = (ex2_TCEevent5 *) Escher_NewxtUMLEvent( self, &ex2_TCEevent5c );
    e->p_b1 = !( ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b1" ))->b1 ) );
    Escher_SendSelfEvent( (Escher_xtUMLEvent_t *) e );
  }
  /* ASSIGN ack_count = ( ack_count + 1 ) */
  ack_count = ( ack_count + 1 );
  ...
  { ex2_TCEevent5 * e = (ex2_TCEevent5 *) Escher_NewxtUMLEvent( self, &ex2_TCEevent5c );
    e->p_b1 = !( ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b2" ))->b2 ) && ( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 == ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b1" ))->b1 ) );
    Escher_SendSelfEvent( (Escher_xtUMLEvent_t *) e );
  }
  /* ASSIGN ack_count = ( ack_count + 1 ) */
  ack_count = ( ack_count + 1 );
  ...
  { ex2_TCEevent6 * e = (ex2_TCEevent6 *) Escher_NewxtUMLEvent( self, &ex2_TCEevent6c );
    e->p_i1 = +( ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.i2" ))->i2 );
    Escher_SendSelfEvent( (Escher_xtUMLEvent_t *) e );
  }
  /* ASSIGN ack_count = ( ack_count + 1 ) */
  ack_count = ( ack_count + 1 );
  ...
  { ex2_TCEevent6 * e = (ex2_TCEevent6 *) Escher_NewxtUMLEvent( self, &ex2_TCEevent6c );
    e->p_i1 = +( ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i1" ))->i1 + ((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.i2" ))->i2 );
    Escher_SendSelfEvent( (Escher_xtUMLEvent_t *) e );
  }
  /* ASSIGN ack_count = ( ack_count + 1 ) */
  ack_count = ( ack_count + 1 );
  ...
  /* ASSIGN ack_count = ( ack_count + 1 ) */
  ack_count = ( ack_count + 1 );
  /* GENERATE TCE6:int event(i1:+ ( BR::ret_int(- 3) + BR::ret_int(6) )) TO self */
  { ex2_TCEevent6 * e = (ex2_TCEevent6 *) Escher_NewxtUMLEvent( self, &ex2_TCEevent6c );
  ...
  { ex2_TCEevent5 * e = (ex2_TCEevent5 *) Escher_NewxtUMLEvent( self, &ex2_TCEevent5c );
    e->p_b1 = !((ex2_TCE *)xtUML_detect_empty_handle( self, "TCE", "self.b2" ))->b2;
    Escher_SendSelfEvent( (Escher_xtUMLEvent_t *) e );
  }
  /* ASSIGN ack_count = ( ack_count + 1 ) */
  ack_count = ( ack_count + 1 );
  ...
  { ex2_TCEevent5 * e = (ex2_TCEevent5 *) Escher_NewxtUMLEvent( self, &ex2_TCEevent5c );
    e->p_b1 = !((ex2_TCE *)xtUML_detect_empty_handle( tce, "TCE", "tce.b2" ))->b2;
    Escher_SendSelfEvent( (Escher_xtUMLEvent_t *) e );
  }
  /* ASSIGN ack_count = ( ack_count + 1 ) */
  ack_count = ( ack_count + 1 );
