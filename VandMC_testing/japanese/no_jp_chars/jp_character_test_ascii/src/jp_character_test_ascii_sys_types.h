/*----------------------------------------------------------------------------
 * File:  jp_character_test_ascii_sys_types.h
 *
...
#ifndef JP_CHARACTER_TEST_ASCII_SYS_TYPES_H
#define JP_CHARACTER_TEST_ASCII_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
...
#define System_DOMAIN_ID 0
#define System_DOMAIN_ID_text "System"
...
#endif
#endif  /* JP_CHARACTER_TEST_ASCII_SYS_TYPES_H */
