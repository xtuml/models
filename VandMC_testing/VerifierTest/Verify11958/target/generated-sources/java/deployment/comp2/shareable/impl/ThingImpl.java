...
public class ThingImpl extends ModelInstance<Thing,Comp2> implements Thing {
    ...
    // constructors
    private ThingImpl( Comp2 context ) {
        this.context = context;
        statemachine = new ThingStateMachine(this, context());
    }


    private ThingImpl( Comp2 context, UniqueId instanceId, int initialState ) {
        super(instanceId);
        this.context = context;
        statemachine = new ThingStateMachine(this, context(), initialState);
    }

    public static Thing create( Comp2 context ) throws XtumlException {
    ...
    public static Thing create( Comp2 context, UniqueId instanceId, int initialState ) throws XtumlException {
    ...
    // static operations
    public static class CLASS extends ActionHome<Comp2> {

        public CLASS( Comp2 context ) {
            super( context );
        }
...
class EmptyThing extends ModelInstance<Thing,Comp2> implements Thing {
