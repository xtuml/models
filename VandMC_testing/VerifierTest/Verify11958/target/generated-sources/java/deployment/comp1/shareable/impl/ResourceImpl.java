...
public class ResourceImpl extends ModelInstance<Resource,Comp1> implements Resource {
    ...
    // constructors
    private ResourceImpl( Comp1 context ) {
    ...
    private ResourceImpl( Comp1 context, int m_ivalue, int m_derivedValue, int initialState ) {
        this.context = context;
    ...
    private ResourceImpl( Comp1 context, UniqueId instanceId, int m_ivalue, int m_derivedValue, int initialState ) {
        super(instanceId);
        this.context = context;
        this.m_ivalue = m_ivalue;
        this.m_derivedValue = m_derivedValue;
    ...
    public static Resource create( Comp1 context ) throws XtumlException {
    ...
    public static Resource create( Comp1 context, int m_ivalue, int m_derivedValue, int initialState ) throws XtumlException {
    ...
    public static Resource create( Comp1 context, UniqueId instanceId, int m_ivalue, int m_derivedValue, int initialState ) throws XtumlException {
...
class EmptyResource extends ModelInstance<Resource,Comp1> implements Resource {
